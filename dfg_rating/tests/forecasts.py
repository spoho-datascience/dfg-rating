...
f_log = LogFunctionForecast(
    outcomes=['home', 'draw', 'away'],
    coefficients=[0.870, -0.302],
    home_team_error=RatingFunctionError(error='normal', loc=0, scale=10),
    away_team_error=RatingFunctionError(error='normal', loc=0, scale=10)
)
#%%
